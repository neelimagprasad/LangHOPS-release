...
def add_partglee_config(cfg):
    ...
    cfg.MODEL.MaskDINO.OBJECT_DETACH = False
    
    # Use LLM to replace Q-Former
    cfg.MODEL.LLM = CN()
    cfg.MODEL.LLM.DEBUG = False
    cfg.MODEL.LLM.USE_LLM = False
    cfg.MODEL.LLM.HIDDEN_SIZE = 2048
    cfg.MODEL.LLM.LLM_TYPE = "microsoft/phi-1_5"
    cfg.MODEL.LLM.LLM_PATH = ""
    cfg.MODEL.LLM.LLM_CONVERSATION_TYPE = "llava_phi"
    cfg.MODEL.LLM.PART_QUERY_MODE = "learnable_query"
    cfg.MODEL.LLM.PART_CLIP_QUERY_PRIOR_PART_NUMS = False
    cfg.MODEL.LLM.CLIP_EMB_PART_ATTEN_MASK = False
    cfg.MODEL.LLM.PART_CLS_EMBED = "learnable"
    cfg.MODEL.LLM.IMG_PROJ_INDIMS = 1024
    
    cfg.MODEL.LLM.VLM = CN()
    cfg.MODEL.LLM.VLM.IS_VLM = False
    cfg.MODEL.LLM.VLM.FREEZE_VISUAL = True
    
    cfg.MODEL.LLM.LORA = CN()
    cfg.MODEL.LLM.LORA.R = 0
    cfg.MODEL.LLM.LORA.ALPHA = 1
    cfg.MODEL.LLM.LORA.DROPOUT = 0.0
    cfg.MODEL.LLM.LORA.TARGET_MODULES = []
    ...
    cfg.MODEL.MaskDINO.TEST.VISUALIZE_AND_SAVE = False
...
#   SPATIAL_MEMORIES: 32
    ...
    cfg.FREEZE_PIXEL_DECODERE = False