...
def _test_loader_from_config(cfg, dataset_name, mapper=None):
    ...
    return {"dataset": dataset, "mapper": mapper, "num_workers": cfg.DATALOADER.NUM_WORKERS, "samples_per_gpu": cfg.SOLVER.TEST_IMS_PER_BATCH,}


@configurable(from_config=_test_loader_from_config)
def build_detection_test_loader(dataset, *, mapper, num_workers=0, samples_per_gpu=1):
    """
    ...
    batch_sampler = torch.utils.data.sampler.BatchSampler(sampler, samples_per_gpu, drop_last=False)
