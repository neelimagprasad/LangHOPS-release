...
_PREDEFINED_SPLITS_SA1B = {
    ...
    "sa1b_joint": ("SA1B/images/sa_000000/", "SA1B/sa_000000_joint.json"),
    "sa1b_500k_joint": ("SA1B/images/", "SA1B/sa1b_subtrain_500k.json"),
...
if __name__.endswith(".builtin"):
    ...
    print("Registering 1 builtin datasets in ", _root)
    # refcoco/g/+
    ...
    # partimagenet zero shot train
    print("Registering partimagenet zero shot ")
