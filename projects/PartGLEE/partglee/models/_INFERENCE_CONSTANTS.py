from ._CONSTANTS import PACO_CATEGORIES, ADE20K_OBJECT_CLASS_NAMES, ADE20K_PART_CLASS_NAMES, PASCALVOC_OBJECT_CLASS_NAMES, \
                        PASCALVOC_PART_CLASS_NAMES, PARTIMAGENET_OBJECT_CATEGORIES, PARTIMAGENET_PART_CATEGORIES, PARTIMAGENET_SEMSEG_OBJECT_CATEGORIES, PARTIMAGENET_SEMSEG_PART_CATEGORIES, PASCAL_OBJECT_CATEGORIES, PASCAL_PART_CATEGORIES, \
                        ...
                        OPENIMAGES_PART_CATEGORIES, ADE20K_BASE_CLASS_NAMES, PASCALVOC_OBJECT_BASE_CLASS_NAMES, PASCALVOC_BASE_CLASS_NAMES, PASCAL_VAL_OBJECT_CATEGORIES, PASCAL_VAL_PART_CATEGORIES, PASCAL_JOINT_CATEGORIES, PASCAL_JOINT_PART_NUMS, PARTIMAGENET_PART_NUMS
...
CRITERION_NUM_CLASSES = {'coco':80, 'coconomask':80, 'coco_clip':80, 'obj365':100, 'obj365_clip':100, 'lvis':100, 'lvis_clip':100, \
                    ...
                    'pascal_joint_object': 20, 'pascal_joint_part': 93, 'partimagenet_joint_object': 11, 'partimagenet_joint_part': 40, 'diagram_joint_object': 11, 'diagram_joint_part': 560, 'part_classification_object': 11, 'part_classification_part': 560, 'partimagenet_semseg_object': 40, 'partimagenet_semseg_part': 147, \
                    ...
                    'seginw_Brain-Tumor': 1, 'partimagenet_parsed_object': 11, 'partimagenet_parsed_part': 40, 'pascal_part_parsed_object': 20, 'pascal_part_parsed_part': 93, 'partimagenet_renamed_joint_object': 11, 'partimagenet_renamed_joint_part': 40,
                    'partimagenet_semseg_object': 40, 'partimagenet_semseg_part': 147,
}

DATASET_PART_NUMS = {
    'pascalvoc': PASCAL_JOINT_PART_NUMS, 
    'partimagenet_joint': PARTIMAGENET_PART_NUMS,
    'partimagenet_renamed_joint': PARTIMAGENET_PART_NUMS,
}
...
TEST_PART_ONLY_DATASETS = []

if __name__ == "__main__":
    
    dataset_name = 'pascal_joint_part'
    category_names = PASCAL_JOINT_CATEGORIES
    # build_category_hiearachy(category_names, PART_DATASETS_PART_CATEGORY_INDEX[dataset_name])
