...
class Trainer(DefaultTrainer):
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        ...
        if evaluator_type in ["sem_seg"]:
            evaluator_list.append(GeneralizedSemSegEvaluator(dataset_name, distributed=True, output_dir=output_folder, post_process_func=dense_crf_post_process if cfg.TEST.DENSE_CRF else None, visualize = cfg.TEST.VISUAIZE))
...
def seed_all(seed):
    ...
    # For cudnn deterministic behavior (may slightly slow down training)
